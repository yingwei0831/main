 ...
 */
public class ImageGridViewAdapter extends MyBaseAdapter {

    private String TAG = ImageGridViewAdapter.class.getSimpleName();

    public ImageGridViewAdapter(Context ct, List list) {
        super(ct, list);
    }
...
//    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            view = LayoutInflater.from(context).inflate(R.layout.item_inner_travel_gridview, null);
        ...
        String imgUrl = String.valueOf(list.get(i));
//        ImageLoaderUtil.getInstance(context).displayImage(imgUrl, holder.imageView);
        setIconData(context, holder.imageView, imgUrl);
        return view;
    }
