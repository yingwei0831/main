...
public class HotelProvinceAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    private LayoutInflater layoutInflater;
    /**
     * 数据集
     */
    private List<HotelProvinceResponse.ProvinceBean> list;
    /**
     * 首字母
     */
    public HashMap<String, Integer> map_IsHead;

    public HotelProvinceAdapter(Context context, List<HotelProvinceResponse.ProvinceBean> list, HashMap<String, Integer> map_IsHead) {
        this.list = list;
