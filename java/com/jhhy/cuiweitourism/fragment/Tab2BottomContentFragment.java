 ...
 */
public class Tab2BottomContentFragment extends Fragment implements IPagerScroll, AdapterView.OnItemClickListener {

    private static final String TAG = Tab2BottomContentFragment.class.getSimpleName();
...
//                            }, 1000);
    ...
    public Tab2BottomContentFragment() {
...
//        return PagerScrollUtils.isFirstChildOnTop(listView) && PagerScrollUtils.isFirstChildOnTop(gridView);
    ...
    @Override
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        LogUtil.e(TAG, "listView onItemClick " +" position = " + i + ", id = " + l);
