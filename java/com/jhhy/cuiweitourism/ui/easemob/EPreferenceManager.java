...
public class EPreferenceManager {
	/**
	 * 保存Preference的name
	 */
	public static final String PREFERENCE_NAME = "saveInfo";
	private static SharedPreferences mSharedPreferences;
	private static EPreferenceManager mPreferencemManager;
	...
	private EPreferenceManager(Context cxt) {
	...
	public static synchronized void init(Context cxt) {
		if (mPreferencemManager == null) {
			mPreferencemManager = new EPreferenceManager(cxt);
		}
	}
	 ...
	 * @return
	 */
	public synchronized static EPreferenceManager getInstance() {
		if (mPreferencemManager == null) {
