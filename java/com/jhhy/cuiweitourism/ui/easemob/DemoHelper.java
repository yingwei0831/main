...
//                            usernickView.setText(message.getFrom());
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                if (chatType == ChatType.Chat) { // 单聊信息
                    ...
                    intent.putExtra(EaseConstant.EXTRA_SHOW_USERNICK, false); //此处设置不显示客服昵称
                }
                return intent;
            }
        });
    ...
    protected void onConnectionConflict(){
        ...
        intent.putExtra(Consts.ACCOUNT_CONFLICT, true);
    ...
    protected void onCurrentAccountRemoved(){
        Intent intent = new Intent(appContext, MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(Consts.ACCOUNT_REMOVED, true);
        appContext.startActivity(intent);
    }
...
//                                Toast.makeText(appContext, intent.getStringExtra("cmd_value"), Toast.LENGTH_SHORT).show();
    ...
    public boolean isRobotMenuMessage(EMMessage message){
    	try {
			JSONObject jsonObj = message.getJSONObjectAttribute(Consts.MESSAGE_ATTR_MSGTYPE);
    ...
    public boolean isEvalMessage(EMMessage message){
		try {
			JSONObject jsonObj = message.getJSONObjectAttribute(Consts.WEICHAT_MSG);
    ...
    public boolean isPictureTxtMessage(EMMessage message){
    	...
    	try {
			jsonObj = message.getJSONObjectAttribute(Consts.MESSAGE_ATTR_MSGTYPE);
		} catch (EaseMobException e) {
		}
    	if(jsonObj == null){
			return false;
    ...
    public JSONObject getAgentInfoByMessage(EMMessage message) {
        try {
            JSONObject jsonWeichat = message.getJSONObjectAttribute(Consts.WEICHAT_MSG);
            if (jsonWeichat == null) {
                return null;
            }
