package com.markmao.pulltorefresh.widght;
...
//        LogUtil.i("XScrollView", "=========== invokeOnScrolling ===========");
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        LogUtil.i("XScrollView", "-------onScrollStateChanged---------");
...
//        LogUtil.i("XScrollView", "-------onScrollChanged--------- l = " + l + ", t = " + t + ", oldl = " + oldl + "，oldt = " +oldt);
        if(myOnXScrollChangedI != null) {
            myOnXScrollChangedI.onXScrollChangedImpl(l, t, oldl, oldt);
        }
    ...
    private onXScrollChangedI myOnXScrollChangedI;
    public interface onXScrollChangedI{
        public void onXScrollChangedImpl(int l, int t, int oldl, int oldt);
    }
    public void setOnXScrollChangedI(onXScrollChangedI l){
        myOnXScrollChangedI = l;
    }

    @Override
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        LogUtil.i("XScrollView", "---------onScroll---------");
