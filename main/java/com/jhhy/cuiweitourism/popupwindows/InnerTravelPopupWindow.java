...
//        listViewFirst.setAdapter(new ArrayAdapter<>(mActivity, android.R.layout.simple_list_item_1, firstList));
...
//        secondList1.add("9天");
//        secondList1.add("10天");
//        secondList1.add("10天以上");

//        secondList3 = new ArrayList<>();
//        secondList3.add("500元以下");
//        secondList3.add("501-1500元");
//        secondList3.add("1501-2500元");
//        secondList3.add("2501-3500元");
//        secondList3.add("3501-4500元");
//        secondList3.add("4501-5500元");
//        secondList3.add("5501-6500元");
//        secondList3.add("6501-7500元");
//        secondList3.add("7501-8500元");
//        secondList3.add("8501-9500元");
//        secondList3.add("10000元以上");
