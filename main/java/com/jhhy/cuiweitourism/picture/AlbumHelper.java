	...
	private void getAlbumColumnData(Cursor cur) {
		if (cur.moveToFirst()) {
			...
			do {
				...
				// Do something with the values.
				LogUtil.i(TAG, _id + " album:" + album + " albumArt:" + albumArt + "albumKey: " + albumKey + " artist: " + artist + " numOfSongs: " + numOfSongs + "---");
				HashMap<String, String> hash = new HashMap<String, String>();
				hash.put("_id", _id + "");
	...
	void buildImagesBucketList() {
		...
		if (cur.moveToFirst()) {
			...
			do {
				...
				LogUtil.i(TAG, _id + ", bucketId: " + bucketId + ", picasaId: " + picasaId + " name:" + name + " path:" + path
		...
		while (itr.hasNext()) {
			...
			LogUtil.d(TAG, entry.getKey() + ", " + bucket.bucketName + ", " + bucket.count + " ---------- ");
			for (int i = 0; i < bucket.imageList.size(); ++i) {
				ImageItem image = bucket.imageList.get(i);
				LogUtil.d(TAG, "----- " + image.imageId + ", " + image.imagePath + ", " + image.thumbnailPath);
			}
		}
