 ...
 */
public class Tab2BottomContentFragment3 extends Fragment implements IPagerScroll, AdapterView.OnItemClickListener {

    private static final String TAG = Tab2BottomContentFragment3.class.getSimpleName();
    ...
    private List<ClassifyArea> listNew = new ArrayList<>();
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case Consts.MESSAGE_CLASSIFY_NEAR:
                    ...
                    if(0 == msg.arg1){
                        ...
                        if(array != null) {
                            ...
                            listNew.add(listRight.get(0));
//                            listNew = listRight;
                            adapterRight.setData(listNew);
    ...
    public Tab2BottomContentFragment3() {
...
//        {"head":{"code":"Publics_classify"},"field":{"type":"1"}} //type:1国内、2出境、102周边
        ...
        biz.getAreaListNearBy(type,  Consts.MESSAGE_CLASSIFY_NEAR);
    }
...
//                LogUtil.i(TAG, "======== listView onScroll ========"+firstVisibleItem +", " +visibleItemCount+", " + totalItemCount);
        ...
        gridView.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(AbsListView absListView, int i) {
//                LogUtil.i(TAG, "======== gridView onScrollStateChanged ========"+i);
            }

            @Override
            public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
//                LogUtil.i(TAG, "======== gridView onScroll ========"+firstVisibleItem +", " +visibleItemCount+", " + totalItemCount);
                if(firstVisibleItem == 0){
                    gridTop = true;
                }else{
                    gridTop = false;
...
//        return PagerScrollUtils.isFirstChildOnTop(listView) && PagerScrollUtils.isFirstChildOnTop(gridView);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        List<ClassifyArea> listGo = new ArrayList<>();
        listGo.add(listRight.get(i));
//        adapterRight.setData(listRight.get((int)l).getListProvince());
        adapterRight.setData(listGo);
    }
}
